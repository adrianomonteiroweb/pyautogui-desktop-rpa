...
def ler_arquivo_csv(nome_arquivo: str, mostrar_info: bool = True) -> Optional[Dict[str, any]]:
    """
    Lê um arquivo CSV do diretório C:\Users\adria\Documents\hobots\abax de forma dinâmica
    
    Args:
        nome_arquivo (str): Nome do arquivo CSV (com ou sem extensão .csv)
        mostrar_info (bool): Se deve exibir informações sobre o arquivo lido
    
    Returns:
        Optional[Dict[str, any]]: Dicionário contendo:
            - 'dados': Lista de dicionários com os dados do CSV
            - 'colunas': Lista com os nomes das colunas
            - 'total_registros': Número total de registros
            - 'nome_arquivo': Nome do arquivo lido
